...
public class Member implements Comparable{
	...
	public String toString(boolean lab){
		return (lab ?"Mem.":"")+String.format("%03d-%02d-%04d  %20s %-20s",ID/1000000,ID/10000%100,ID%100000,firstName,lastName);
	}
	...
	public String htmlColumns(){
		return String.format("<TD>%03d-%02d-%04d</TD> <TD>%20s</TD> <TD>%-20s</TD>",ID/1000000,ID/10000%100,ID%100000,firstName,lastName);
	}
